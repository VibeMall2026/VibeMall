# Generated by Django 5.2.9 on 2026-03-14 00:27
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('Hub', '0077_remove_activitylog_admin_user_and_more'),
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'indexes': [models.Index(fields=['-report_date'], name='Hub_salesre_report__397c1e_idx'), models.Index(fields=['report_type', '-report_date'], name='Hub_salesre_report__b43c79_idx')],
        ...
        migrations.CreateModel(
            ...
            options={
                'ordering': ['-timestamp'],
                'indexes': [models.Index(fields=['-timestamp'], name='Hub_activit_timesta_05e58e_idx'), models.Index(fields=['admin_user', '-timestamp'], name='Hub_activit_admin_u_67787a_idx')],
            },
        ),
        migrations.CreateModel(
            name='DiscountCoupon',
            ...
            options={
                'ordering': ['-created_at'],
                'indexes': [models.Index(fields=['code'], name='Hub_discoun_code_b353ab_idx'), models.Index(fields=['status', 'valid_until'], name='Hub_discoun_status_1880bd_idx')],
            },
        ),
        migrations.CreateModel(
            name='LowStockAlert',
            ...
            options={
                'ordering': ['-created_at'],
                'indexes': [models.Index(fields=['product_id', '-created_at'], name='Hub_lowstoc_product_d49371_idx'), models.Index(fields=['status', '-created_at'], name='Hub_lowstoc_status_5f4090_idx')],
            },
        ),
    ]
