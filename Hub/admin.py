...
from .models_security_access import DataAccessLog, IPWhitelist, LoginAttempt, SellerAccessInvite, SecurityAlert, SecurityAuditLog, SecurityRole, TwoFactorAuthentication, UserRoleAssignment, UserSession
...
class SellerAccessInviteAdmin(admin.ModelAdmin):
    list_display = ['id', 'email', 'is_active', 'expires_at', 'used_at', 'created_at']
    search_fields = ['email', 'user__username']
    list_filter = ['is_active', 'created_at']

admin.site.register(SellerAccessInvite, SellerAccessInviteAdmin)
