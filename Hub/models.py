...
class Slider(models.Model):
    ...
    benefit_1_text = models.CharField(max_length=80, blank=True, default='', help_text="First benefit text e.g. 'Premium Quality'")
    benefit_2_text = models.CharField(max_length=80, blank=True, default='', help_text="Second benefit text e.g. 'Fast & Reliable Delivery'")
    benefit_3_text = models.CharField(max_length=80, blank=True, default='', help_text="Third benefit text e.g. 'Easy Returns'")
    offer_eyebrow = models.CharField(max_length=50, blank=True, default='', help_text="Offer badge top text e.g. 'UPTO'")
    offer_main_text = models.CharField(max_length=40, blank=True, default='', help_text="Offer badge main text e.g. '50%'")
    offer_subtext = models.CharField(max_length=50, blank=True, default='', help_text="Offer badge middle text e.g. 'OFF'")
    offer_footer_text = models.CharField(max_length=120, blank=True, default='', help_text="Offer badge footer text e.g. '+ EXTRA 10% CASHBACK'")
