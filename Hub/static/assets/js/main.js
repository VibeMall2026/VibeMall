...
(function ($) {
	...
	// Top Deals Slider
	if (jQuery("#deals-slider .product-slider").length > 0) {
		new Swiper('#deals-slider .product-slider', {
			slidesPerView: 1,
			spaceBetween: 0,
			loop: true,
			observer: true,
			...
			navigation: {
				nextEl: '#deals-slider .deals-next',
				prevEl: '#deals-slider .deals-prev',
			},
			breakpoints: {
				550: {
					slidesPerView: 2,
	...
	// Top Selling Slider
	if (jQuery("#selling-slider .product-slider").length > 0) {
		new Swiper('#selling-slider .product-slider', {
			slidesPerView: 1,
			spaceBetween: 0,
			loop: true,
			observer: true,
			...
			navigation: {
				nextEl: '#selling-slider .selling-next',
				prevEl: '#selling-slider .selling-prev',
			},
			breakpoints: {
				550: {
					slidesPerView: 2,
	...
	// Top Featured Slider
	if (jQuery("#featured-slider .product-slider").length > 0) {
		new Swiper('#featured-slider .product-slider', {
			slidesPerView: 1,
			spaceBetween: 0,
			loop: true,
			observer: true,
			...
			navigation: {
				nextEl: '#featured-slider .featured-next',
				prevEl: '#featured-slider .featured-prev',
			},
			breakpoints: {
				550: {
					slidesPerView: 2,
	...
	// Recommended Slider
	if (jQuery("#recommended-slider .product-slider").length > 0) {
		new Swiper('#recommended-slider .product-slider', {
			slidesPerView: 1,
			spaceBetween: 0,
			loop: true,
			observer: true,
			...
			navigation: {
				nextEl: '#recommended-slider .recommended-next',
				prevEl: '#recommended-slider .recommended-prev',
			},
			breakpoints: {
				550: {
					slidesPerView: 2,
