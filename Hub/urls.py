...
urlpatterns = [
    ...
    path('admin-panel/products/gallery-image/meesho-crop/<int:image_id>/', views.admin_meesho_crop_gallery_image, name='admin_meesho_crop_gallery_image'),
    path('admin-panel/products/main-image/meesho-crop/<int:product_id>/', views.admin_meesho_crop_main_image, name='admin_meesho_crop_main_image'),
    path('admin-panel/products/meesho-crop-all/<int:product_id>/', views.admin_meesho_crop_all_images, name='admin_meesho_crop_all_images'),
    ...
    path('admin-panel/seller-earnings/', views.admin_seller_earnings, name='admin_seller_earnings'),
    path('admin-panel/seller-payout/', views.admin_seller_payout, name='admin_seller_payout'),
    path('admin-panel/seller-payouts/', views.admin_seller_payouts, name='admin_seller_payouts'),
    path('admin-panel/seller-settlements/', views.admin_seller_settlements, name='admin_seller_settlements'),
    ...
    path('admin-panel/returns/upi-verifications/', views.admin_upi_verifications, name='admin_upi_verifications'),
    path('admin-panel/returns/upi-verification/<int:verification_id>/review/', views.admin_upi_verification_review, name='admin_upi_verification_review'),
