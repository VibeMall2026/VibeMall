      ...
      <main className="min-h-screen flex items-center justify-center pt-24 pb-12 px-8">
        ...
        >
          ...
          <form className="space-y-8" onSubmit={submitLogin}>
            ...
            <div className="space-y-2">
              <div className="flex justify-between items-end">
                ...
                <button
                  ...
                  className="text-[10px] tracking-[0.2em] uppercase text-outline hover:text-primary transition-colors flex items-center gap-1"
                >
                  <Eye className="w-3 h-3" /> {showPassword ? 'Hide' : 'Show'}
                </button>
              </div>
              <input 
            ...
            <div className="flex items-center justify-between text-xs tracking-wide">
              <label className="flex items-center gap-2 cursor-pointer group">
                <input
                  ...
                  className="rounded-none border-outline/30 text-primary focus:ring-0 w-4 h-4 transition-all"
                />
            ...
            {authError && (
              <p className="text-xs text-red-700 tracking-wide">{authError}</p>
            )}
