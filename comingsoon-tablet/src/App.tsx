...
export default function App() {
  ...
  useEffect(() => {
    ...
    const fetchLaunchDate = async () => {
      try {
        ...
        // Keep fallback date when server page is unavailable.
      }
    };
  ...
  return (
    <div className="relative min-h-screen overflow-hidden selection:bg-secondary/20 pt-24">
      {/* Texture Overlay */}
      ...
      <header className="fixed top-0 w-full z-50 bg-background/80 backdrop-blur-xl flex justify-between items-center px-8 md:px-16 py-6">
      ...
      <main className="relative z-10 min-h-screen flex flex-col items-center justify-center px-6 md:px-24 py-20">
        ...
        <div className="max-w-3xl w-full text-center space-y-12">
          ...
          <div className="space-y-6">
            ...
            <p className="font-label text-[10px] tracking-[0.2rem] uppercase text-secondary">Launch Window: {launchDate}</p>
          </div>
      ...
      <footer className="w-full py-10 px-8 bg-[#f0eee9] flex flex-col md:flex-row justify-between items-center gap-6 relative z-10">
        ...
        <div className="flex gap-8 font-body text-[10px] tracking-[0.2em] uppercase text-primary">
