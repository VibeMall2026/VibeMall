...
class AlgoConfig:
    ...
    range_min_atr_multiplier: float = 1.0
    breakout_buffer_atr: float = 0.05
    min_breakout_body_ratio: float = 0.55
    min_volume_multiplier: float = 1.10
    ...
    trail_atr_mult: float = 0.65        # Tighter trailing stop
    dollar_profit_trigger: float = 5.0  # Trigger at $5 floating profit
    dollar_profit_lock: float = 3.0     # Lock $3 profit
    dollar_lock_enabled: bool = True
    quick_book_profit_usd: float = 3.5
    risky_quick_book_profit_usd: float = 2.0
    extended_profit_min_usd: float = 5.0
    extended_profit_max_usd: float = 7.0
    early_sl_avoid_ratio: float = 0.55
